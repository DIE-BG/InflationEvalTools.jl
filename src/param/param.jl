...
Obtains the matrix of parametric month-to-month variations for the
...
the parametric month-to-month variations. Currently works only if `base`
...
occurrence (also called parametric month-to-month variations).
